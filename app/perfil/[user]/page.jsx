...
export default function Perfil({ params }) {
  ...
  return (
    <main>
      ...
      <section className="relative mb-4 overflow-hidden rounded-2xl bg-ink p-5">
        <div
        ...
        <div className="relative flex items-center gap-3.5">
          <span className="holo flex h-[58px] w-[58px] shrink-0 items-center justify-center rounded-full font-display text-2xl font-extrabold text-white">
            {s.name[0]}
          </span>
          <div>
      ...
      <h2 className="mb-2.5 px-0.5 font-display text-sm font-bold">Sus carpetas</h2>
        ...
        {s.reviews.map((r) => (
          ...
          >
            <div className="mb-1 flex justify-between">
              ...
              <span className="text-[11px] text-amber">{"★".repeat(r.stars)}</span>
            </div>
