      ...
      <main className="flex min-h-[calc(100vh-6rem)] flex-col">
        <header className="mb-3 flex items-center gap-3">
          <button
            ...
            className="text-xs font-semibold text-mut"
          >
            ← Chats
          </button>
        ...
        <div className="mb-3 rounded-xl border border-amber/40 bg-amber/10 px-3 py-2 text-[11px] leading-relaxed text-mut">
          🛡 Mantén la negociación y el pago dentro de la plataforma para que tu
          compra quede protegida. Nunca compartas datos bancarios por chat.
        </div>
        ...
        <footer className="sticky bottom-20 flex gap-2 bg-paper pt-2">
          <input
            value={draft}
      ...
      <section className="flex flex-col gap-2">
        {chats.map((c) => (
          <button
            ...
            className="flex items-center gap-3 rounded-2xl border border-line bg-white px-3.5 py-3 text-left transition hover:border-vio/40"
          >
