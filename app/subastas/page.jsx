...
export default function Subastas() {
  ...
  return (
    <main>
      ...
      {/* subasta destacada */}
      <section className="relative mb-4 overflow-hidden rounded-2xl bg-ink p-4.5 pb-4">
        <div
        ...
        <div className="relative">
          ...
          <div className="flex gap-3.5">
            <div
              className="flex h-[108px] w-[78px] shrink-0 items-center justify-center rounded-lg border border-white/15 text-4xl"
              style={{
            ...
            <div className="flex-1">
              ...
              <h2 className="my-0.5 font-display text-[16.5px] font-extrabold leading-tight text-white">
                {featCard.name}
              </h2>
          ...
          <p className="mt-2.5 text-[10.5px] leading-relaxed text-white/50">
            🛡 Pujas con método de pago registrado · si pujan en los últimos 3
            min, el cierre se extiende 3 min (anti-sniping)
          </p>
        </div>
      </section>
